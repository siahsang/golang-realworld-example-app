...
func (c *Core) GetProfileByUserName(ctx context.Context, username string, followerID *int64) (*models.Profile, error) {
...
func (c *Core) GetProfileByUserId(ctx context.Context, userId int64) (*models.Profile, error) {
	user, err := c.GetUsersById(ctx, userId)
	if err != nil {
		return nil, xerrors.New(err)
	}
...
func (c *Core) FollowUser(ctx context.Context, followerUser auth.User, followeeUserName string) (*models.Profile, error) {
	...
	profile, err := c.GetProfileByUserName(ctx, followerUser.Username, &followerUser.ID)
	if err != nil {
		return nil, xerrors.New(err)
	}
